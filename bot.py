...
async def on_message(msg):
    if msg.content.lower().startswith("?"):
        ...
        if cmd == ("jdk15"):
            ...
            await msg.channel.send("ZGC is the best garbage collector for Yatopia.")
            ...
            e = discord.Embed()
            e.set_image(
                url="https://media.discordapp.net/attachments/613163671870242842/674294268646391828/93qXFd0-2.png")
            await msg.channel.send(embed=e)
        elif cmd == ("help"):
            embed = discord.Embed(title="Help", description="List of all commands", color=0xffff00)
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/attachments/745296670631395482/745298764788400238/yatipia.png")
