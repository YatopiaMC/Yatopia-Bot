    ...
    static {
        ...
        pluginSuggestions.put("paper", new PluginServerSuggestion(
                () -> {
                    ...
                    suggestions.put("Spartan", new PluginSuggestion("", "Spartan is a poorly written anti-cheat. You should find an alternative such as [AAC](https://www.spigotmc.org/resources/aac-advanced-anti-cheat-hack-kill-aura-blocker.6442/) or [NCP](https://www.spigotmc.org/resources/nocheatplus.26/)."));
                    return suggestions;
                }
        ));
